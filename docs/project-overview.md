...
```
pru-sg-mlops-stacks         <- Root directory. Both monorepo and polyrepo are supported.
│
├── pru_sg_mlops_stacks       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
