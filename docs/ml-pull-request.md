...
Opening a pull request will trigger a[workflow](../.github/workflows/pru-sg-mlops-stacks-run-tests-fs.yml) 
...
* [Staging workspace registered model](https://adb-1974343288999839.19.azuredatabricks.net#mlflow/models/staging-pru-sg-mlops-stacks-model)
* [Prod workspace registered model](https://adb-1974343288999839.19.azuredatabricks.net#mlflow/models/prod-pru-sg-mlops-stacks-model)
