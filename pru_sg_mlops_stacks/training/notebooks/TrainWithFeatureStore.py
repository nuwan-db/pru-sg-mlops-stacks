...
# ``pru_sg_mlops_stacks/databricks-resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-pru-sg-mlops-stacks-experiment",
    label="MLflow experiment name",
)

# MLflow registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "dev-pru-sg-mlops-stacks-model", label="Model Name"
)
