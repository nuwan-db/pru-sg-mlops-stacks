...
#
# It runs as part of CD and by an automated model training job -> validation -> deployment job defined under ``pru_sg_mlops_stacks/databricks-resources/model-workflow-resource.yml``
#
#
# Parameters:
#
...
# * custom_metrics_loader_function          - Specifies the name of the function in pru-sg-mlops-stacks/validation/validation.py that returns custom metrics.
# * validation_thresholds_loader_function   - Specifies the name of the function in pru-sg-mlops-stacks/validation/validation.py that returns model validation thresholds.
#
...
dbutils.widgets.text(
    "experiment_name",
    "/dev-pru-sg-mlops-stacks-experiment",
    "Experiment Name",
)
...
dbutils.widgets.text("model_name", "dev-pru-sg-mlops-stacks-model", "Model Name")
